            ...
            for (int i=0;i<pending.length();i++) {
                ...
                try {
                    ...
                    if ("mobile_scan".equals(origin) && !url.isEmpty()) {
                        ...
                        lead.put("source_id","mobile_biznesoferty"); lead.put("source_name",x.optString("source_name","BiznesOferty.pl"));
                        ...
                        JSONObject raw=new JSONObject();raw.put("origin","dealmaker_mobile");raw.put("verification_status","source_listing");lead.put("raw",raw);
